...
namespace Repositorios.Seguridad
{
    public class OpcionMenuRepositorio : IOpcionMenuRepositorio
    {
        ...
        public async Task<IEnumerable<OpcionesMenuUsuarioModelo>> ObtenerMenuAsync(string nitUsuario)
        {
            ...
            {
                throw new ResponseException("Ha ocurrido un error al consultar el listados de menús, consulte con el administrador del sistema.", EstadoSolicitudHttp.warning, CodigoEstadoRespuestaHttp.BadRequest);
            }
        }
